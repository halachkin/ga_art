...
populace_velikost=80;    	% velikost populace
G=500;   	% pocet generaci v ukoncovaci podmince
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
populace=funcGreedySearch(mesta); %vychozi populace neni nahodna ale z greedySearch
...
figure('Name','GA-TSP-iniGreedy-fitness');
%hold on;grid on;
